...
module.exports = {
  ...
  // cancelBooking : async args =>{
  //   try{
  //    const cancelBooking = await (await Booking.findById(args.bookingId)).populate('event')
  //    const event ={...cancelBooking.event._doc,_id:cancelBooking.event.id,
  //     creator : user.bind(this,cancelBooking.event._doc.creator)}
  //    await Booking.deleteOne({_id:args.bookingId})
  //    return event;
  //   }
  //   catch(err){
